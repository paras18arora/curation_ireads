...
<p>This tutorial will show you how to set up a development Ruby on Rails environment that will allow your applications to use a MySQL database, on an CentOS 7 or RHEL server. First, we will cover how to install MySQL and the MySQL adapter gem. Then we'll show you how to create a rails application that uses MySQL as its database server.</p>
...
<p>If you don't already have MySQL installed, let's do that now. CentOS uses MariaDB as a drop-in replacement for MySQL.</p>

<p>Install MySQL and its development libraries:</p>
...
<pre class="code-pre "><code langs="">sudo systemctl enable mariadb.service
</code></pre>
...
<p>You're now ready to start development on your Ruby on Rails application, with MySQL as the database, on CentOS 7!</p>
