...
<p>In this guide, we will demonstrate how to install and configure <code>git</code> on an Ubuntu 16.04 system.  We will cover how to install the software in two different ways, each of which have benefits.</p>

<p>This tutorial assumes you are signed in as a <a href="https://indiareads/community/articles/initial-server-setup-with-ubuntu-16-04">non-root user</a> which you can learn how to create here.</p>
...
<p>This will download and install <code>git</code> to your system.  You will still have to complete the configuration steps that we cover in the "setup" section, so feel free to skip to <a href="https://indiareads/community/tutorials/how-to-install-git-on-ubuntu-16-04#how-to-set-up-git">that section</a> now.</p>
...
<p>After you have installed the necessary dependencies, you can go ahead and get the version of git you want by visiting the <a href="https://github.com/git/git">git project's mirror on GitHub</a>.</p>
...
<p><img src="https://assets.digitalocean.com/articles/git_install_1604/change_branch.png" alt="git change branch" /></p>

<p>Next, on the right side of the page, right-click the <strong>Download ZIP</strong> button and copy the link address.</p>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">wget <span class="highlight">https://github.com/git/git/archive/v2.8.1.zip</span> -O git.zip
</li></ul></code></pre>
...
<p>As you can see, this has a slightly different format.  The information is stored in your <code>git</code> configuration file, which you can optionally edit by hand with your text editor like this:</p>
