...
<p>In this guide, we will show you how to get Django up and running on an Ubuntu 16.04 server.  After installation, we'll show you how to start a new project to use as the basis for your site.</p>
...
<p>Before you begin, you should have a non-root user with <code>sudo</code> privileges available on your Ubuntu 16.04 server.  To set this up, follow our <a href="https://indiareads/community/tutorials/initial-server-setup-with-ubuntu-16-04">Ubuntu 16.04 initial server setup guide</a>.</p>

<p>When you are ready to continue, follow the steps below.</p>
...
<p>Next, select which version Python version you want to use with Django.  For Python 2, type:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo apt-get install python-django
</li></ul></code></pre>
<p>If, instead, you would like to use Python 3 with Django, type:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo apt-get install python3-django
</li></ul></code></pre>
...
</li></ul></code></pre><pre class="code-pre "><code langs=""><div class="secondary-code-label " title="Output">Output</div>1.8.7
</code></pre>
<p>This means that the software was successfully installed.  You may also notice that the Django version is not the latest stable.  To learn a bit about how to use the software, skip ahead to learn <a href="https://indiareads/community/tutorials/how-to-install-the-django-web-framework-on-ubuntu-16-04#creating-a-sample-project">how to create sample project</a>.</p>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo pip install django
</li></ul></code></pre>
<p>If you are using Python 3, use the <code>pip3</code> command instead:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo pip3 install django
</li></ul></code></pre>
<p>You can verify that the installation was successful by typing:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">django-admin --version
</li></ul></code></pre><pre class="code-pre "><code langs=""><div class="secondary-code-label " title="Output">Output</div>1.9.6
</code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">virtualenv <span class="highlight">newenv</span>
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">source <span class="highlight">newenv</span>/bin/activate
</li></ul></code></pre>
...
<pre class="code-pre custom_prefix"><code langs=""><ul class="prefixed"><li class="line" prefix="(newenv) $">pip install django
</li></ul></code></pre>
<p>You can verify the installation by typing:</p>
<pre class="code-pre custom_prefix"><code langs=""><ul class="prefixed"><li class="line" prefix="(newenv) $">django-admin --version
</li></ul></code></pre><pre class="code-pre "><code langs=""><div class="secondary-code-label " title="Output">Output</div>1.9.6
</code></pre>
<p>To leave your virtual environment, you need to issue the <code>deactivate</code> command from anywhere on the system:</p>
<pre class="code-pre custom_prefix"><code langs=""><ul class="prefixed"><li class="line" prefix="(newenv) $">deactivate
</li></ul></code></pre>
...
</li><li class="line" prefix="$">source <span class="highlight">newenv</span>/bin/activate
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo apt-get install git python-pip
</li></ul></code></pre>
<p>If you are using Python 3 instead, you should type this:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo apt-get install git python3-pip
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">git clone git://github.com/django/django ~/django-dev
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo pip install -e ~/django-dev
</li></ul></code></pre>
<p>If you are using Python 3, type:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo pip3 install -e ~/django-dev
</li></ul></code></pre>
<p>You can verify that the installation was successful by typing:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">django-admin --version
</li></ul></code></pre><pre class="code-pre "><code langs=""><div class="secondary-code-label " title="Output">Output</div>1.10.dev20160516172816
</code></pre>
...
<p>Follow the steps below that match the Python version you are using.</p>

<h3 id="python-2">Python 2</h3>

<p>You can use the <code>django-admin</code> command to create a project:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">django-admin startproject <span class="highlight">projectname</span>
</li><li class="line" prefix="$">cd <span class="highlight">projectname</span>
</li></ul></code></pre>
...
If you were already in a project directory that you created for use with the <code>virtualenv</code> command, you can tell Django to place the management script and inner directory into the current directory without the extra layer by typing this (notice the ending dot):</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">django-admin startproject <span class="highlight">projectname</span> .
</li></ul></code></pre>
<p></p></span>

<p>To bootstrap the database (this uses SQLite by default) on more recent versions of Django, you can type:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python manage.py migrate
</li></ul></code></pre>
<p>If the <code>migrate</code> command doesn't work, you likely are using an older version of Django.  Instead, you can type this:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python manage.py syncdb
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python manage.py createsuperuser
</li></ul></code></pre>
<p>You will be prompted for a username, an email address, and a password for the user.</p>

<p>Skip ahead to the section on testing with your development version.</p>
...
<p>To bootstrap the database (this uses SQLite by default) on more recent versions of Django, you can type:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python3 manage.py migrate
</li></ul></code></pre>
<p>If the <code>migrate</code> command doesn't work, you likely are using an older version of Django.  Instead, you can type this:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python3 manage.py syncdb
</li></ul></code></pre>
<p>You will be asked to create an administrative user as part of this process.  Select a username, email address, and password for the user.</p>

<p>If you used the <code>migrate</code> command above, you'll need to create the administrative user manually.  You can create an administrative user by typing:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python3 manage.py createsuperuser
</li></ul></code></pre>
<p>You will be prompted for a username, an email address, and a password for the user.</p>

<h3 id="testing-with-your-development-server">Testing with your Development Server</h3>

<p>Once you have a user, you can start up the Django development server to see what a fresh Django project looks like.  You should only use this for development purposes.</p>

<p>Before you try the development server, make sure you open the port in your firewall.  If you are using UFW like in the initial server setup guide, you can open the appropriate port by typing:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo ufw allow 8000
</li></ul></code></pre>
<p>Now, start up the development server.</p>

<p>For Python 2, run:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python manage.py runserver 0.0.0.0:8000
</li></ul></code></pre>
<p>For Python 3, run:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">python3 manage.py runserver 0.0.0.0:8000
</li></ul></code></pre>
...
<p>You should now have Django installed on your Ubuntu 16.04 server, providing the main tools you need to create powerful web applications.  You should also know how to start a new project and launch the developer server.  Leveraging a complete web framework like Django can help make development faster, allowing you to concentrate only on the unique aspects of your applications.</p>
