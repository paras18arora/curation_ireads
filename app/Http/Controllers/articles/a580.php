...
<p>In this guide, we will cover how to set up and use Bottle to create simple web applications on a Ubuntu 14.04 server.</p>
...
<ul>
<li>A Ubuntu 14.04 Droplet</li>
<li>A working knowledge of how to edit text files from the command line</li>
<li>A <a href="https://indiareads/community/tutorials/initial-server-setup-with-ubuntu-14-04">sudo user</a></li>
</ul>

<h2 id="step-1-—-install-a-virtual-environment-for-python">Step 1 — Install a Virtual Environment for Python</h2>

<p>Python, the programming language that Bottle is built for, comes installed on Ubuntu by default.</p>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo apt-get install python-virtualenv
</li></ul></code></pre>
...
<p>Install SQLite with this command:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo apt-get install sqlite
</li></ul></code></pre>
...
<p>Press <code>CTRL-C</code> to stop the application. (<code>CTRL-Z</code> is a stronger stop signal.)</p>
...
<p>Once you're ready for production, we highly recommend making a more robust startup plan for your app. (Just starting it in the background means your app will stop after a server reboot.) Ubuntu 14.04 uses <a href="https://indiareads/community/tutorials/the-upstart-event-system-what-it-is-and-how-to-use-it">Upstart</a>.</p>
