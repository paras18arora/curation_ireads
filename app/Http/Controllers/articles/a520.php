<link rel='stylesheet' href='digital_ocean.css'><br><img src=https://community-cdn-digitalocean-com.global.ssl.fastly.net/assets/tutorials/images/large/Graylog_tutorial.png?1459466441/> <br> 
...
<p>The setup described in this tutorial requires an CentOS 7 server with at least 2GB of RAM. You also need root or superuser access (Steps 1-4 of <a href="https://indiareads/community/articles/initial-server-setup-with-centos-7">Initial Server Setup with CentOS 7</a>).</p>
...
<p>The MongoDB installation is simple and quick. Run the following command to import the MongoDB public GPG key into rpm:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo rpm --import https://www.mongodb.org/static/pgp/server-3.2.asc
</li></ul></code></pre>
<p>Create the MongoDB source list:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">echo '[mongodb-org-3.2]
</li><li class="line" prefix="$">name=MongoDB Repository
</li><li class="line" prefix="$">baseurl=https://repo.mongodb.org/yum/redhat/$releasever/mongodb-org/3.2/x86_64/
</li><li class="line" prefix="$">gpgcheck=1
</li><li class="line" prefix="$">enabled=1' | sudo tee /etc/yum.repos.d/mongodb-org-3.2.repo
</li></ul></code></pre>
<p>Install the latest stable version of MongoDB with this command:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo yum install -y mongodb-org
</li></ul></code></pre>
<p>Now start MongoDB:</p>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">wget --no-cookies --no-check-certificate --header "Cookie: gpw_e24=http%3A%2F%2Fwww.oracle.com%2F; oraclelicense=accept-securebackup-cookie" "http://download.oracle.com/otn-pub/java/jdk/8u73-b02/jdk-8u73-linux-x64.rpm"
</li></ul></code></pre>
...
<p>Create a new yum repository file for Elasticsearch by running this command:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">echo '[elasticsearch-1.7]
</li><li class="line" prefix="$">name=Elasticsearch repository for 1.7.x packages
</li><li class="line" prefix="$">baseurl=http://packages.elastic.co/elasticsearch/1.7/centos
</li><li class="line" prefix="$">gpgcheck=1
</li><li class="line" prefix="$">gpgkey=http://packages.elastic.co/GPG-KEY-elasticsearch
</li><li class="line" prefix="$">enabled=1' | sudo tee /etc/yum.repos.d/elasticsearch.repo
</li></ul></code></pre>
...
<p>First, download the Graylog RPM package to your system with this command:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo rpm -Uvh https://packages.graylog2.org/repo/packages/graylog-1.3-repository-el7_latest.rpm
</li></ul></code></pre>
<p>Then install the <code>graylog-server</code> package with these commands:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo yum -y install graylog-server
</li></ul></code></pre>
...
</li><li class="line" prefix="$">sudo yum -y install pwgen
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">PASSWORD=$(echo -n <span class="highlight">password</span> | sha256sum | awk '{print $1}')
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo systemctl start graylog-server
</li></ul></code></pre>
...
<p>Install Graylog Web with this command:</p>
<pre class="code-pre "><code langs="">sudo yum -y install graylog-web
</code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo systemctl restart graylog-web
</li></ul></code></pre>
...
<pre class="code-pre custom_prefix"><code langs=""><ul class="prefixed"><li class="line" prefix="client$">sudo systemctl restart rsyslog
</li></ul></code></pre>
