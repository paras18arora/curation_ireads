<link rel='stylesheet' href='digital_ocean.css'><br><img src=https://community-cdn-digitalocean-com.global.ssl.fastly.net/assets/tutorials/images/large/Let&#39;s-Encrypt-twitter-%28HAProxy%29.png?1458317298/> <br> 
...
<p>In this tutorial, we will show you how to use Let's Encrypt to obtain a free SSL certificate and use it with HAProxy on CentOS 7. We will also show you how to automatically renew your SSL certificate.</p>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo yum install git bc
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo systemctl stop haproxy
</li></ul></code></pre>
...
<p>Install HAProxy with yum:</p>
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo yum install haproxy
</li></ul></code></pre>
...
<p>Add this line to the <strong>global</strong> section to configure the maximum size of temporary DHE keys that are generated:</p>
<div class="code-label " title="haproxy.cfg — 1 of 5">haproxy.cfg — 1 of 5</div><pre class="code-pre "><code langs="">   tune.ssl.default-dh-param 2048
</code></pre>
<h3 id="frontend-sections">Frontend Sections</h3>

<p>Now we're ready to define our <code>frontend</code> sections.</p>

<p><span class="note"><strong>Note:</strong> The default HAProxy configuration includes a frontend and several backends. Feel free to delete them as we will not be using them.<br /></span></p>
...
<div class="code-label " title="haproxy.cfg — 2 of 5">haproxy.cfg — 2 of 5</div><pre class="code-pre "><code langs="">frontend www-http
...
<div class="code-label " title="haproxy.cfg — 3 of 5">haproxy.cfg — 3 of 5</div><pre class="code-pre "><code langs="">frontend www-https
...
<div class="code-label " title="haproxy.cfg — 4 of 5">haproxy.cfg — 4 of 5</div><pre class="code-pre "><code langs="">backend www-backend
...
<div class="code-label " title="haproxy.cfg — 5 of 5">haproxy.cfg — 5 of 5</div><pre class="code-pre "><code langs="">backend letsencrypt-backend
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo systemctl start haproxy
</li></ul></code></pre>
...
<pre class="code-pre command"><code langs=""><ul class="prefixed"><li class="line" prefix="$">sudo /usr/local/sbin/le-renew-haproxy
