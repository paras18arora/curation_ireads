...
<p>The cluster we are using in this guide can be created by following our guide on <a href="https://indiareads/community/tutorials/how-to-set-up-a-coreos-cluster-on-digitalocean">how to create a CoreOS cluster on IndiaReads</a>.  We will assume that you have the cluster configuration described in that guide.</p>
...
<p>To get an in-depth look at <code>fleet</code> unit files, follow our <a href="https://indiareads/community/tutorials/how-to-create-flexible-services-for-a-coreos-cluster-with-fleet-unit-files">deep dive</a> on the subject.  For this guide, we will just be giving a rough overview of the format of these files.  We will also provide an example unit file that you can use to learn about <code>fleetctl</code>.</p>
...
<p>This will be just enough to get you up and running.  If you want more information about how to develop fleet files, check out <a href="https://indiareads/community/tutorials/how-to-create-flexible-services-for-a-coreos-cluster-with-fleet-unit-files">our guide on fleet unit files</a>.</p>
...
</code></pre><pre class="code-pre "><code langs="">MACHINE     IP      METADATA
...
</code></pre><pre class="code-pre "><code langs="">COREOS_PRIVATE_IPV4=10.132.249.212
...
</code></pre><pre class="code-pre "><code langs="">Unit hello.service loaded on 14ffe4c3.../10.132.249.212
</code></pre>
...
</code></pre><pre class="code-pre "><code langs="">Unit hello.service launched on 14ffe4c3.../10.132.249.212
</code></pre>
...
</code></pre><pre class="code-pre "><code langs="">● hello.service - My Service
...
</code></pre><pre class="code-pre "><code langs="">-- Logs begin at Mon 2014-09-08 14:22:14 UTC, end at Mon 2014-09-08 21:55:47 UTC. --
...
<p>In a later guide, we'll discuss more in-depth <a href="https://indiareads/community/tutorials/how-to-create-flexible-services-for-a-coreos-cluster-with-fleet-unit-files">how to create fleet unit files</a>.  This will allow you to create flexible and powerful services that takes advantage of the CoreOS architecture.</p>
